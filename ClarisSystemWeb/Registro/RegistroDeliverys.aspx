<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaPrincipal.Master" AutoEventWireup="true" CodeBehind="RegistroDeliverys.aspx.cs" Inherits="ClarisSystemWeb.Registro.RegistroDeliverys" %>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style5" colspan="3" style="border-style: inset; border-width: medium; font-family: Georgia, 'Times New Roman', Times, serif; background-color: #FF0066">&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label1" runat="server" Font-Names="Snap ITC" Font-Size="X-Large" ForeColor="Black" Text="Registro Deliverys"></asp:Label>
                </td>
            </tr>
            <tr>
                <td class="auto-style7">IdDeliverys</td>
                <td class="auto-style6">
                    <asp:TextBox ID="iddeliveryTextBox" runat="server" Height="23px" Width="183px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="auto-style6">
                    <asp:TextBox ID="nombresTextBox" runat="server" Height="23px" Width="243px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="auto-style6">
                    <asp:TextBox ID="telefonoTextBox" runat="server" Height="23px" Width="180px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="auto-style6">
                    <asp:TextBox ID="celularTextBox" runat="server" Height="23px" Width="182px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="auto-style6">
                    <asp:TextBox ID="cedulaTextBox" runat="server" Height="23px" Width="182px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="auto-style6">
                    <asp:TextBox ID="emailTextBox" runat="server" Height="23px" Width="270px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td class="auto-style6">
                    <asp:TextBox ID="direccionTextBox" runat="server" Height="23px" Width="267px"></asp:TextBox>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
